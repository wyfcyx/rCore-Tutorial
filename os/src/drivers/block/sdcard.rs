...
use crate::drivers::soc::dmac::{dma_channel, DMAC};
use crate::drivers::soc::gpio;
use crate::drivers::soc::gpiohs;
use crate::drivers::soc::spi::{aitm, frame_format, tmod, work_mode, SPI};
